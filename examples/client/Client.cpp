...
void Client::readDataFromStdin()
{
    ...
    do {
        ...
        static const std::map<unsigned, SendFunc> Map = {
            std::make_pair(my_proto::MsgId_SimpleInts, &Client::sendSimpleInts),
            std::make_pair(my_proto::MsgId_ScaledInts, &Client::sendScaledInts),
            std::make_pair(my_proto::MsgId_Floats, &Client::sendFloats),
            std::make_pair(my_proto::MsgId_Enums, &Client::sendEnums),
            std::make_pair(my_proto::MsgId_Sets, &Client::sendSets),
            std::make_pair(my_proto::MsgId_Bitfields, &Client::sendBitfields),
            std::make_pair(my_proto::MsgId_Strings, &Client::sendStrings),
            std::make_pair(my_proto::MsgId_Datas, &Client::sendDatas),
            std::make_pair(my_proto::MsgId_Lists, &Client::sendLists),
            std::make_pair(my_proto::MsgId_Optionals, &Client::sendOptionals),
            std::make_pair(my_proto::MsgId_Variants, &Client::sendVariants),
        };
...
{
    my_proto::message::SimpleInts<OutputMsg> msg;
...
{
    my_proto::message::ScaledInts<OutputMsg> msg;
...
{
    my_proto::message::Floats<OutputMsg> msg;
...
{
    using OutMsg = my_proto::message::Enums<OutputMsg>;
    OutMsg msg;
...
{
    my_proto::message::Sets<OutputMsg> msg;
...
{
    using OutMsg = my_proto::message::Bitfields<OutputMsg>;
    OutMsg msg;
...
{
    my_proto::message::Strings<OutputMsg> msg;
...
{
    my_proto::message::Datas<OutputMsg> msg;
...
{
    my_proto::message::Lists<OutputMsg> msg;
...
{
    my_proto::message::Optionals<OutputMsg> msg;
...
{
    my_proto::message::Variants<OutputMsg> msg;
